...
Settings.llm = Fireworks(api_key=os.getenv('FIREWORKS_API_KEY'), model="accounts/fireworks/models/mixtral-8x22b-instruct") #accounts/fireworks/models/llama-v3-70b-instruct
...
#     index=index, 
#     similarity_top_k=10  # Retrieve top 10 most similar nodes
# )
